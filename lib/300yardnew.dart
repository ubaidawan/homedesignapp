...
class Threehundred extends StatefulWidget {
  const Threehundred({Key key}) : super(key: key);

  @override
  _ThreehundredState createState() => _ThreehundredState();
}

class _ThreehundredState extends State<Threehundred> {
  @override
  ...
  FindMap(){
    ...
    else if (Room == 1 && Hall == 1 && Kitchen == 1 && Bathroom == 5 ) {
      image = "assets/booking.png";
      text = true;
    }
    ...
    else if (Room == 2 && Hall == 1 && Kitchen == 1 && Bathroom == 5 ) {
      image = "assets/booking.png";
      text = true;
    ...
    else if (Room == 3 && Hall == 1 && Kitchen == 1 && Bathroom == 5 ) {
      image = "assets/booking.png";
      text = true;
    }
    ...
    else if (Room == 4 && Hall == 1 && Kitchen == 1 && Bathroom == 5 ) {
      image = "assets/booking.png";
      text = true;
    }
    else if (Room == 5 && Hall == 1 && Kitchen == 1 && Bathroom == 1 ) {
      image = "assets/logos.png";
      text = true;
    }
    else if (Room == 5 && Hall == 1 && Kitchen == 1 && Bathroom == 2 ) {
      image = "assets/logos.png";
      text = true;
    }
    else if (Room == 5 && Hall == 1 && Kitchen == 1 && Bathroom == 3 ) {
      image = "assets/"
          "logos.png";
      text = true;
    }
    else if (Room == 5 && Hall == 1 && Kitchen == 1 && Bathroom == 4 ) {
      image = "assets/logos.png";
      text = true;
    }
    else if (Room == 5 && Hall == 1 && Kitchen == 1 && Bathroom == 5 ) {
      image = "assets/booking.png";
      text = true;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text("300 Square Yards")),
      ),
                  ...
                  child: Container(
                    ...
                    child: DropdownButtonFormField<String>(
                        ...
                        onChanged: (newVal) {
                          setState(() {
                            _ROOM = newVal;
                            oneTwentyYardmodellist[0].sqyard="300";
