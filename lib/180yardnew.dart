...
class Oneeighty extends StatefulWidget {
  const Oneeighty({Key key}) : super(key: key);

  @override
  _OneeightyState createState() => _OneeightyState();
}

class _OneeightyState extends State<Oneeighty> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text("180 Square Yards")),
      ),
                  ...
                  child: Container(
                    ...
                    child: DropdownButtonFormField<String>(
                        ...
                        onChanged: (newVal) {
                          setState(() {
                            _ROOM = newVal;
                            oneTwentyYardmodellist[0].sqyard="180";
